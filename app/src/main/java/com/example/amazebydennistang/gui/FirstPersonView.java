...
import com.example.amazebydennistang.generation.BSPBranch;
import com.example.amazebydennistang.generation.BSPLeaf;
import com.example.amazebydennistang.generation.BSPNode;
import com.example.amazebydennistang.generation.Floorplan;
import com.example.amazebydennistang.generation.Wall;
import com.example.amazebydennistang.gui.ColorTheme.MazeColors;
...
public class FirstPersonView {
	...
	private void drawWall(Wall wall) {
		...
		currentPanel.setColor(ColorTheme.getColor(wall.getColor()).toArgb());
	...
	private boolean drawPolygons(int x1, int x2, int y11, int y12, int y21, int y22) {
		...
		while (x1i <= x2) {
			...
			currentPanel.addFilledPolygon(xps, yps, 4);
