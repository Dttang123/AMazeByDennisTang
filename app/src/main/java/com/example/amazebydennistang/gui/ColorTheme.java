...
public class ColorTheme {
	...
	// General color settings across multiple screens #916f41, #222222, #FFFF99
	...
	private static class ColorSettings {
		Color getColor(MazeColors color, float percentToExit) {
			...
			LOGGER.log(Level.FINEST, "Given:" + color + ", returns the color: " + result);
			return result;
		}
		Color getWallColor(final int distance, final int cc, final int extensionX) {
			LOGGER.log(Level.FINEST, "Returns Color (Regardless of Input): " + Color.LTGRAY);
